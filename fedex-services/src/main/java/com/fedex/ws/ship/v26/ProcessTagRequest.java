...
public class ProcessTagRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the userDetail value for this ProcessTagRequest.
     * 
     * @return userDetail
     */
    ...
    /**
     * Sets the userDetail value for this ProcessTagRequest.
     * 
     * @param userDetail
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ProcessTagRequest"));
