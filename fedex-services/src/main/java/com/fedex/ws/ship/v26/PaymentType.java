...
public class PaymentType implements java.io.Serializable {
    ...
    public static final PaymentType CREDIT_CARD = new PaymentType(_CREDIT_CARD);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PaymentType"));
    }
    /**
