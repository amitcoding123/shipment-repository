...
public class LabelFormatType implements java.io.Serializable {
    ...
    public static final LabelFormatType ERROR = new LabelFormatType(_ERROR);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "LabelFormatType"));
    }
    /**
