...
public class PackageBarcodes  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.BinaryBarcode[] binaryBarcodes;

    /* String-style barcodes for this package. */
    private com.fedex.ws.ship.v26.StringBarcode[] stringBarcodes;

    public PackageBarcodes() {
    }

    public PackageBarcodes(
           com.fedex.ws.ship.v26.BinaryBarcode[] binaryBarcodes,
           com.fedex.ws.ship.v26.StringBarcode[] stringBarcodes) {
     ...
     */
    public com.fedex.ws.ship.v26.BinaryBarcode[] getBinaryBarcodes() {
     ...
     */
    public void setBinaryBarcodes(com.fedex.ws.ship.v26.BinaryBarcode[] binaryBarcodes) {
        this.binaryBarcodes = binaryBarcodes;
    }

    public com.fedex.ws.ship.v26.BinaryBarcode getBinaryBarcodes(int i) {
        return this.binaryBarcodes[i];
    }

    public void setBinaryBarcodes(int i, com.fedex.ws.ship.v26.BinaryBarcode _value) {
     ...
     */
    public com.fedex.ws.ship.v26.StringBarcode[] getStringBarcodes() {
     ...
     */
    public void setStringBarcodes(com.fedex.ws.ship.v26.StringBarcode[] stringBarcodes) {
        this.stringBarcodes = stringBarcodes;
    }

    public com.fedex.ws.ship.v26.StringBarcode getStringBarcodes(int i) {
        return this.stringBarcodes[i];
    }

    public void setStringBarcodes(int i, com.fedex.ws.ship.v26.StringBarcode _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PackageBarcodes"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("binaryBarcodes");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BinaryBarcodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BinaryBarcode"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "StringBarcodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "StringBarcode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
