...
public class BrokerDetail  implements java.io.Serializable {
    private com.fedex.ws.ship.v26.BrokerType type;

    private com.fedex.ws.ship.v26.Party broker;

    public BrokerDetail() {
    }

    public BrokerDetail(
           com.fedex.ws.ship.v26.BrokerType type,
           com.fedex.ws.ship.v26.Party broker) {
           this.type = type;
           this.broker = broker;
    }
     ...
     * @return type
     */
    public com.fedex.ws.ship.v26.BrokerType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ws.ship.v26.BrokerType type) {
        this.type = type;
    }
     ...
     * @return broker
     */
    public com.fedex.ws.ship.v26.Party getBroker() {
        return broker;
    }
     ...
     * @param broker
     */
    public void setBroker(com.fedex.ws.ship.v26.Party broker) {
        this.broker = broker;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BrokerDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BrokerType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("broker");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Broker"));
