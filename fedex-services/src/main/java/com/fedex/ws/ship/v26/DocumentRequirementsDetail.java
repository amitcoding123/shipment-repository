...
public class DocumentRequirementsDetail  implements java.io.Serializable {
    private com.fedex.ws.ship.v26.RequiredDocumentType[] requiredDocuments;

    private com.fedex.ws.ship.v26.DocumentGenerationDetail[] generationDetails;

    /* Lists the documents that are not accepted by FedEx for this
     * shipment. */
    private com.fedex.ws.ship.v26.EnterpriseDocumentType[] prohibitedDocuments;

    public DocumentRequirementsDetail() {
    }

    public DocumentRequirementsDetail(
           com.fedex.ws.ship.v26.RequiredDocumentType[] requiredDocuments,
           com.fedex.ws.ship.v26.DocumentGenerationDetail[] generationDetails,
           com.fedex.ws.ship.v26.EnterpriseDocumentType[] prohibitedDocuments) {
     ...
     */
    public com.fedex.ws.ship.v26.RequiredDocumentType[] getRequiredDocuments() {
        return requiredDocuments;
    }
     ...
     */
    public void setRequiredDocuments(com.fedex.ws.ship.v26.RequiredDocumentType[] requiredDocuments) {
        this.requiredDocuments = requiredDocuments;
    }

    public com.fedex.ws.ship.v26.RequiredDocumentType getRequiredDocuments(int i) {
        return this.requiredDocuments[i];
    }

    public void setRequiredDocuments(int i, com.fedex.ws.ship.v26.RequiredDocumentType _value) {
     ...
     */
    public com.fedex.ws.ship.v26.DocumentGenerationDetail[] getGenerationDetails() {
        return generationDetails;
    }
     ...
     */
    public void setGenerationDetails(com.fedex.ws.ship.v26.DocumentGenerationDetail[] generationDetails) {
        this.generationDetails = generationDetails;
    }

    public com.fedex.ws.ship.v26.DocumentGenerationDetail getGenerationDetails(int i) {
        return this.generationDetails[i];
    }

    public void setGenerationDetails(int i, com.fedex.ws.ship.v26.DocumentGenerationDetail _value) {
     ...
     * shipment.
     */
    public com.fedex.ws.ship.v26.EnterpriseDocumentType[] getProhibitedDocuments() {
     ...
     * shipment.
     */
    public void setProhibitedDocuments(com.fedex.ws.ship.v26.EnterpriseDocumentType[] prohibitedDocuments) {
        this.prohibitedDocuments = prohibitedDocuments;
    }

    public com.fedex.ws.ship.v26.EnterpriseDocumentType getProhibitedDocuments(int i) {
        return this.prohibitedDocuments[i];
    }

    public void setProhibitedDocuments(int i, com.fedex.ws.ship.v26.EnterpriseDocumentType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "DocumentRequirementsDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("requiredDocuments");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RequiredDocuments"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RequiredDocumentType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "GenerationDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "DocumentGenerationDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ProhibitedDocuments"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "EnterpriseDocumentType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
