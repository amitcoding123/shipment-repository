...
public class RegulatoryWaiver  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.Message[] advisories;
    ...
    public RegulatoryWaiver(
           ...
           com.fedex.ws.ship.v26.Message[] advisories) {
           this.id = id;
     ...
     * @return advisories
     */
    public com.fedex.ws.ship.v26.Message[] getAdvisories() {
        return advisories;
    }
     ...
     * @param advisories
     */
    public void setAdvisories(com.fedex.ws.ship.v26.Message[] advisories) {
        this.advisories = advisories;
    }

    public com.fedex.ws.ship.v26.Message getAdvisories(int i) {
        return this.advisories[i];
    }

    public void setAdvisories(int i, com.fedex.ws.ship.v26.Message _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RegulatoryWaiver"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Advisories"));
