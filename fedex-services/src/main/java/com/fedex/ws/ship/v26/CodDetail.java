...
public class CodDetail  implements java.io.Serializable {
    private com.fedex.ws.ship.v26.Money codCollectionAmount;

    /* Specifies the details of the charges are to be added to the
     * COD collect amount. */
    private com.fedex.ws.ship.v26.CodAddTransportationChargesDetail addTransportationChargesDetail;

    /* Identifies the type of funds FedEx should collect upon package
     * delivery */
    private com.fedex.ws.ship.v26.CodCollectionType collectionType;
    ...
    private com.fedex.ws.ship.v26.Party codRecipient;
     ...
     * payment of the COD. */
    private com.fedex.ws.ship.v26.ContactAndAddress financialInstitutionContactAndAddress;
    ...
    private com.fedex.ws.ship.v26.CodReturnReferenceIndicatorType referenceIndicator;

    /* Only used with multi-piece COD shipments sent in multiple transactions.
     * Required on last transaction only. */
    private com.fedex.ws.ship.v26.TrackingId returnTrackingId;

    public CodDetail() {
    }

    public CodDetail(
           com.fedex.ws.ship.v26.Money codCollectionAmount,
           com.fedex.ws.ship.v26.CodAddTransportationChargesDetail addTransportationChargesDetail,
           com.fedex.ws.ship.v26.CodCollectionType collectionType,
           com.fedex.ws.ship.v26.Party codRecipient,
           com.fedex.ws.ship.v26.ContactAndAddress financialInstitutionContactAndAddress,
           java.lang.String remitToName,
           com.fedex.ws.ship.v26.CodReturnReferenceIndicatorType referenceIndicator,
           com.fedex.ws.ship.v26.TrackingId returnTrackingId) {
     ...
     */
    public com.fedex.ws.ship.v26.Money getCodCollectionAmount() {
        return codCollectionAmount;
    }
     ...
     */
    public void setCodCollectionAmount(com.fedex.ws.ship.v26.Money codCollectionAmount) {
        this.codCollectionAmount = codCollectionAmount;
    }
     ...
     * COD collect amount.
     */
    public com.fedex.ws.ship.v26.CodAddTransportationChargesDetail getAddTransportationChargesDetail() {
     ...
     * COD collect amount.
     */
    public void setAddTransportationChargesDetail(com.fedex.ws.ship.v26.CodAddTransportationChargesDetail addTransportationChargesDetail) {
        this.addTransportationChargesDetail = addTransportationChargesDetail;
    }
     ...
     * delivery
     */
    public com.fedex.ws.ship.v26.CodCollectionType getCollectionType() {
     ...
     * delivery
     */
    public void setCollectionType(com.fedex.ws.ship.v26.CodCollectionType collectionType) {
        this.collectionType = collectionType;
    }
     ...
     * that prints the COD receipt.
     */
    public com.fedex.ws.ship.v26.Party getCodRecipient() {
        return codRecipient;
    }
     ...
     * that prints the COD receipt.
     */
    public void setCodRecipient(com.fedex.ws.ship.v26.Party codRecipient) {
        this.codRecipient = codRecipient;
    }
     ...
     * payment of the COD.
     */
    public com.fedex.ws.ship.v26.ContactAndAddress getFinancialInstitutionContactAndAddress() {
     ...
     * payment of the COD.
     */
    public void setFinancialInstitutionContactAndAddress(com.fedex.ws.ship.v26.ContactAndAddress financialInstitutionContactAndAddress) {
        this.financialInstitutionContactAndAddress = financialInstitutionContactAndAddress;
    }
     ...
     * the COD return shipping label.
     */
    public com.fedex.ws.ship.v26.CodReturnReferenceIndicatorType getReferenceIndicator() {
     ...
     * the COD return shipping label.
     */
    public void setReferenceIndicator(com.fedex.ws.ship.v26.CodReturnReferenceIndicatorType referenceIndicator) {
        this.referenceIndicator = referenceIndicator;
    }
     ...
     * Required on last transaction only.
     */
    public com.fedex.ws.ship.v26.TrackingId getReturnTrackingId() {
     ...
     * Required on last transaction only.
     */
    public void setReturnTrackingId(com.fedex.ws.ship.v26.TrackingId returnTrackingId) {
        this.returnTrackingId = returnTrackingId;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CodDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("codCollectionAmount");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CodCollectionAmount"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "AddTransportationChargesDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CodAddTransportationChargesDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("collectionType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CollectionType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CodCollectionType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("codRecipient");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CodRecipient"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "FinancialInstitutionContactAndAddress"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RemitToName"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ReferenceIndicator"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CodReturnReferenceIndicatorType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("returnTrackingId");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ReturnTrackingId"));
