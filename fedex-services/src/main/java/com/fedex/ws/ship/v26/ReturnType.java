...
public class ReturnType implements java.io.Serializable {
    ...
    public static final java.lang.String _VOICE_CALL_TAG = "VOICE_CALL_TAG";
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ReturnType"));
    }
    /**
