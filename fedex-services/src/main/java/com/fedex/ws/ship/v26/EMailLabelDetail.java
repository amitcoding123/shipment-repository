...
public class EMailLabelDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.EMailRecipient[] recipients;
    ...
    public EMailLabelDetail(
           ...
           com.fedex.ws.ship.v26.EMailRecipient[] recipients) {
     ...
     * @return recipients
     */
    public com.fedex.ws.ship.v26.EMailRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * @param recipients
     */
    public void setRecipients(com.fedex.ws.ship.v26.EMailRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.fedex.ws.ship.v26.EMailRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.fedex.ws.ship.v26.EMailRecipient _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "EMailLabelDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Recipients"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "EMailRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
