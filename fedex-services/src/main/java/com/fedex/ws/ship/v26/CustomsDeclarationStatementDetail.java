...
public class CustomsDeclarationStatementDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.CustomsDeclarationStatementType[] types;

    /* Specifies the NAFTA low value statement information. */
    private com.fedex.ws.ship.v26.NaftaLowValueStatementDetail naftaLowValueStatementDetail;

    public CustomsDeclarationStatementDetail() {
    }

    public CustomsDeclarationStatementDetail(
           com.fedex.ws.ship.v26.CustomsDeclarationStatementType[] types,
           com.fedex.ws.ship.v26.NaftaLowValueStatementDetail naftaLowValueStatementDetail) {
           this.types = types;
     ...
     * and/or certifications that apply to this shipment.
     */
    public com.fedex.ws.ship.v26.CustomsDeclarationStatementType[] getTypes() {
        return types;
    }
     ...
     * and/or certifications that apply to this shipment.
     */
    public void setTypes(com.fedex.ws.ship.v26.CustomsDeclarationStatementType[] types) {
        this.types = types;
    }

    public com.fedex.ws.ship.v26.CustomsDeclarationStatementType getTypes(int i) {
        return this.types[i];
    }

    public void setTypes(int i, com.fedex.ws.ship.v26.CustomsDeclarationStatementType _value) {
        this.types[i] = _value;
    }
     ...
     */
    public com.fedex.ws.ship.v26.NaftaLowValueStatementDetail getNaftaLowValueStatementDetail() {
     ...
     */
    public void setNaftaLowValueStatementDetail(com.fedex.ws.ship.v26.NaftaLowValueStatementDetail naftaLowValueStatementDetail) {
        this.naftaLowValueStatementDetail = naftaLowValueStatementDetail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CustomsDeclarationStatementDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("types");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Types"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CustomsDeclarationStatementType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "NaftaLowValueStatementDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "NaftaLowValueStatementDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
