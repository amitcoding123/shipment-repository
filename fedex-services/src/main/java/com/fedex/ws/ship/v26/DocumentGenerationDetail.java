...
public class DocumentGenerationDetail  implements java.io.Serializable {
    private com.fedex.ws.ship.v26.EnterpriseDocumentType type;

    private org.apache.axis.types.NonNegativeInteger minimumCopiesRequired;

    private com.fedex.ws.ship.v26.RequirementType letterhead;

    private com.fedex.ws.ship.v26.RequirementType electronicSignature;

    public DocumentGenerationDetail() {
    }

    public DocumentGenerationDetail(
           com.fedex.ws.ship.v26.EnterpriseDocumentType type,
           org.apache.axis.types.NonNegativeInteger minimumCopiesRequired,
           com.fedex.ws.ship.v26.RequirementType letterhead,
           com.fedex.ws.ship.v26.RequirementType electronicSignature) {
           this.type = type;
     ...
     * @return type
     */
    public com.fedex.ws.ship.v26.EnterpriseDocumentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ws.ship.v26.EnterpriseDocumentType type) {
        this.type = type;
    }
     ...
     * @return letterhead
     */
    public com.fedex.ws.ship.v26.RequirementType getLetterhead() {
        return letterhead;
    }
     ...
     * @param letterhead
     */
    public void setLetterhead(com.fedex.ws.ship.v26.RequirementType letterhead) {
        this.letterhead = letterhead;
    }
     ...
     */
    public com.fedex.ws.ship.v26.RequirementType getElectronicSignature() {
        return electronicSignature;
    }
     ...
     */
    public void setElectronicSignature(com.fedex.ws.ship.v26.RequirementType electronicSignature) {
        this.electronicSignature = electronicSignature;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "DocumentGenerationDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "MinimumCopiesRequired"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Letterhead"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RequirementType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("electronicSignature");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ElectronicSignature"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RequirementType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
