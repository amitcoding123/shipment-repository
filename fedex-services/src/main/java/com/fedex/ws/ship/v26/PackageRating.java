...
public class PackageRating  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.PackageRateDetail[] packageRateDetails;
    ...
    public PackageRating(
           ...
           com.fedex.ws.ship.v26.PackageRateDetail[] packageRateDetails) {
     ...
     * for a specific rate type.
     */
    public com.fedex.ws.ship.v26.PackageRateDetail[] getPackageRateDetails() {
     ...
     * for a specific rate type.
     */
    public void setPackageRateDetails(com.fedex.ws.ship.v26.PackageRateDetail[] packageRateDetails) {
        this.packageRateDetails = packageRateDetails;
    }

    public com.fedex.ws.ship.v26.PackageRateDetail getPackageRateDetails(int i) {
        return this.packageRateDetails[i];
    }

    public void setPackageRateDetails(int i, com.fedex.ws.ship.v26.PackageRateDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PackageRating"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PackageRateDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PackageRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
