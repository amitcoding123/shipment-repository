...
public class HazardousCommodityContent  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.HazardousCommodityDescription description;

    /* Specifies the amount of the commodity in alternate units. */
    private com.fedex.ws.ship.v26.HazardousCommodityQuantityDetail quantity;

    /* This describes the inner receptacle details for a hazardous
     * commodity within the dangerous goods container. */
    private com.fedex.ws.ship.v26.HazardousCommodityInnerReceptacleDetail[] innerReceptacles;

    /* Customer-provided specifications for handling individual commodities. */
    private com.fedex.ws.ship.v26.HazardousCommodityOptionDetail options;

    /* Specifies the details of any radio active materials within
     * the commodity. */
    private com.fedex.ws.ship.v26.RadionuclideDetail radionuclideDetail;

    /* The total mass of the contained explosive substances, without
     * the mass of any casings, bullets, shells, etc. */
    private com.fedex.ws.ship.v26.NetExplosiveDetail netExplosiveDetail;

    public HazardousCommodityContent() {
    }

    public HazardousCommodityContent(
           com.fedex.ws.ship.v26.HazardousCommodityDescription description,
           com.fedex.ws.ship.v26.HazardousCommodityQuantityDetail quantity,
           com.fedex.ws.ship.v26.HazardousCommodityInnerReceptacleDetail[] innerReceptacles,
           com.fedex.ws.ship.v26.HazardousCommodityOptionDetail options,
           com.fedex.ws.ship.v26.RadionuclideDetail radionuclideDetail,
           com.fedex.ws.ship.v26.NetExplosiveDetail netExplosiveDetail) {
     ...
     */
    public com.fedex.ws.ship.v26.HazardousCommodityDescription getDescription() {
        return description;
    }
     ...
     */
    public void setDescription(com.fedex.ws.ship.v26.HazardousCommodityDescription description) {
        this.description = description;
    }
     ...
     */
    public com.fedex.ws.ship.v26.HazardousCommodityQuantityDetail getQuantity() {
        return quantity;
    }
     ...
     */
    public void setQuantity(com.fedex.ws.ship.v26.HazardousCommodityQuantityDetail quantity) {
        this.quantity = quantity;
    }
     ...
     * commodity within the dangerous goods container.
     */
    public com.fedex.ws.ship.v26.HazardousCommodityInnerReceptacleDetail[] getInnerReceptacles() {
     ...
     * commodity within the dangerous goods container.
     */
    public void setInnerReceptacles(com.fedex.ws.ship.v26.HazardousCommodityInnerReceptacleDetail[] innerReceptacles) {
        this.innerReceptacles = innerReceptacles;
    }

    public com.fedex.ws.ship.v26.HazardousCommodityInnerReceptacleDetail getInnerReceptacles(int i) {
        return this.innerReceptacles[i];
    }

    public void setInnerReceptacles(int i, com.fedex.ws.ship.v26.HazardousCommodityInnerReceptacleDetail _value) {
     ...
     */
    public com.fedex.ws.ship.v26.HazardousCommodityOptionDetail getOptions() {
        return options;
    }
     ...
     */
    public void setOptions(com.fedex.ws.ship.v26.HazardousCommodityOptionDetail options) {
        this.options = options;
    }
     ...
     * the commodity.
     */
    public com.fedex.ws.ship.v26.RadionuclideDetail getRadionuclideDetail() {
     ...
     * the commodity.
     */
    public void setRadionuclideDetail(com.fedex.ws.ship.v26.RadionuclideDetail radionuclideDetail) {
        this.radionuclideDetail = radionuclideDetail;
    }
     ...
     * the mass of any casings, bullets, shells, etc.
     */
    public com.fedex.ws.ship.v26.NetExplosiveDetail getNetExplosiveDetail() {
     ...
     * the mass of any casings, bullets, shells, etc.
     */
    public void setNetExplosiveDetail(com.fedex.ws.ship.v26.NetExplosiveDetail netExplosiveDetail) {
        this.netExplosiveDetail = netExplosiveDetail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "HazardousCommodityContent"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("description");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Description"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "HazardousCommodityDescription"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "HazardousCommodityQuantityDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("innerReceptacles");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "InnerReceptacles"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "HazardousCommodityInnerReceptacleDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "HazardousCommodityOptionDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("radionuclideDetail");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RadionuclideDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RadionuclideDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("netExplosiveDetail");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "NetExplosiveDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "NetExplosiveDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
