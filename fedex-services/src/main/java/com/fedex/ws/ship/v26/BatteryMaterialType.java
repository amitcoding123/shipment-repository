...
public class BatteryMaterialType implements java.io.Serializable {
    ...
    public static final BatteryMaterialType UNKNOWN = new BatteryMaterialType(_UNKNOWN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BatteryMaterialType"));
    }
    /**
