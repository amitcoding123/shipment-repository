...
public class RadionuclideActivity  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.RadioactivityUnitOfMeasure unitOfMeasure;
    ...
    public RadionuclideActivity(
           ...
           com.fedex.ws.ship.v26.RadioactivityUnitOfMeasure unitOfMeasure) {
           this.value = value;
     ...
     */
    public com.fedex.ws.ship.v26.RadioactivityUnitOfMeasure getUnitOfMeasure() {
        return unitOfMeasure;
    }
     ...
     * @param unitOfMeasure
     */
    public void setUnitOfMeasure(com.fedex.ws.ship.v26.RadioactivityUnitOfMeasure unitOfMeasure) {
        this.unitOfMeasure = unitOfMeasure;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RadionuclideActivity"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "UnitOfMeasure"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RadioactivityUnitOfMeasure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
