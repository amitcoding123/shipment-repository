...
public class ValidateShipmentRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the userDetail value for this ValidateShipmentRequest.
     * 
     * @return userDetail
     */
    ...
    /**
     * Sets the userDetail value for this ValidateShipmentRequest.
     * 
     * @param userDetail
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ValidateShipmentRequest"));
