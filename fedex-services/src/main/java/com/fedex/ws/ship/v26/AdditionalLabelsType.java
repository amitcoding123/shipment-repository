...
public class AdditionalLabelsType implements java.io.Serializable {
    ...
    public static final java.lang.String _DESTINATION_CONTROL_STATEMENT = "DESTINATION_CONTROL_STATEMENT";
    ...
    public static final java.lang.String _SECOND_ADDRESS = "SECOND_ADDRESS";
    ...
    public static final AdditionalLabelsType DESTINATION_CONTROL_STATEMENT = new AdditionalLabelsType(_DESTINATION_CONTROL_STATEMENT);
    ...
    public static final AdditionalLabelsType SECOND_ADDRESS = new AdditionalLabelsType(_SECOND_ADDRESS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "AdditionalLabelsType"));
    }
    /**
