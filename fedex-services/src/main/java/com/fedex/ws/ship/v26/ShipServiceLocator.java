...
public class ShipServiceLocator extends org.apache.axis.client.Service implements com.fedex.ws.ship.v26.ShipService {
    ...
    public com.fedex.ws.ship.v26.ShipPortType getShipServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.fedex.ws.ship.v26.ShipPortType getShipServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fedex.ws.ship.v26.ShipServiceSoapBindingStub _stub = new com.fedex.ws.ship.v26.ShipServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fedex.ws.ship.v26.ShipPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fedex.ws.ship.v26.ShipServiceSoapBindingStub _stub = new com.fedex.ws.ship.v26.ShipServiceSoapBindingStub(new java.net.URL(ShipServicePort_address), this);
                _stub.setPortName(getShipServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShipService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShipServicePort"));
        }
