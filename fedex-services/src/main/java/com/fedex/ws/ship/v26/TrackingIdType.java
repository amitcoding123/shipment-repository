...
public class TrackingIdType implements java.io.Serializable {
    ...
    public static final TrackingIdType INTERNAL = new TrackingIdType(_INTERNAL);
    public static final TrackingIdType UNKNOWN = new TrackingIdType(_UNKNOWN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "TrackingIdType"));
    }
    /**
