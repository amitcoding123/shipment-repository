...
public class PendingShipmentDetail  implements java.io.Serializable {
    private com.fedex.ws.ship.v26.PendingShipmentType type;
    ...
    private com.fedex.ws.ship.v26.EMailLabelDetail emailLabelDetail;

    private com.fedex.ws.ship.v26.PendingShipmentProcessingOptionType[] processingOptions;

    /* These are documents that are recommended to be included with
     * the shipment. */
    private com.fedex.ws.ship.v26.RecommendedDocumentType[] recommendedDocumentSpecification;

    /* Upload document details provided by the initator of the shipment. */
    private com.fedex.ws.ship.v26.UploadDocumentReferenceDetail[] documentReferences;

    public PendingShipmentDetail() {
    }

    public PendingShipmentDetail(
           com.fedex.ws.ship.v26.PendingShipmentType type,
           java.util.Date expirationDate,
           com.fedex.ws.ship.v26.EMailLabelDetail emailLabelDetail,
           com.fedex.ws.ship.v26.PendingShipmentProcessingOptionType[] processingOptions,
           com.fedex.ws.ship.v26.RecommendedDocumentType[] recommendedDocumentSpecification,
           com.fedex.ws.ship.v26.UploadDocumentReferenceDetail[] documentReferences) {
           this.type = type;
     ...
     * @return type
     */
    public com.fedex.ws.ship.v26.PendingShipmentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ws.ship.v26.PendingShipmentType type) {
        this.type = type;
    }
     ...
     */
    public com.fedex.ws.ship.v26.EMailLabelDetail getEmailLabelDetail() {
     ...
     */
    public void setEmailLabelDetail(com.fedex.ws.ship.v26.EMailLabelDetail emailLabelDetail) {
        this.emailLabelDetail = emailLabelDetail;
    }
     ...
     */
    public com.fedex.ws.ship.v26.PendingShipmentProcessingOptionType[] getProcessingOptions() {
        return processingOptions;
    }
     ...
     */
    public void setProcessingOptions(com.fedex.ws.ship.v26.PendingShipmentProcessingOptionType[] processingOptions) {
        this.processingOptions = processingOptions;
    }
     ...
     * the shipment.
     */
    public com.fedex.ws.ship.v26.RecommendedDocumentType[] getRecommendedDocumentSpecification() {
     ...
     * the shipment.
     */
    public void setRecommendedDocumentSpecification(com.fedex.ws.ship.v26.RecommendedDocumentType[] recommendedDocumentSpecification) {
        this.recommendedDocumentSpecification = recommendedDocumentSpecification;
    }
     ...
     */
    public com.fedex.ws.ship.v26.UploadDocumentReferenceDetail[] getDocumentReferences() {
     ...
     */
    public void setDocumentReferences(com.fedex.ws.ship.v26.UploadDocumentReferenceDetail[] documentReferences) {
        this.documentReferences = documentReferences;
    }

    public com.fedex.ws.ship.v26.UploadDocumentReferenceDetail getDocumentReferences(int i) {
        return this.documentReferences[i];
    }

    public void setDocumentReferences(int i, com.fedex.ws.ship.v26.UploadDocumentReferenceDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PendingShipmentDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PendingShipmentType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "EmailLabelDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "EMailLabelDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("processingOptions");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ProcessingOptions"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PendingShipmentProcessingOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RecommendedDocumentSpecification"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RecommendedDocumentType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "DocumentReferences"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "UploadDocumentReferenceDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
