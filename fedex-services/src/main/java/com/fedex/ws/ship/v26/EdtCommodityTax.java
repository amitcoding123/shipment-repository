...
public class EdtCommodityTax  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.EdtTaxDetail[] taxes;

    private com.fedex.ws.ship.v26.Money total;
    ...
    public EdtCommodityTax(
           ...
           com.fedex.ws.ship.v26.EdtTaxDetail[] taxes,
           com.fedex.ws.ship.v26.Money total) {
     ...
     * @return taxes
     */
    public com.fedex.ws.ship.v26.EdtTaxDetail[] getTaxes() {
        return taxes;
    }
     ...
     * @param taxes
     */
    public void setTaxes(com.fedex.ws.ship.v26.EdtTaxDetail[] taxes) {
        this.taxes = taxes;
    }

    public com.fedex.ws.ship.v26.EdtTaxDetail getTaxes(int i) {
        return this.taxes[i];
    }

    public void setTaxes(int i, com.fedex.ws.ship.v26.EdtTaxDetail _value) {
        this.taxes[i] = _value;
    }
     ...
     * @return total
     */
    public com.fedex.ws.ship.v26.Money getTotal() {
        return total;
    }
     ...
     * @param total
     */
    public void setTotal(com.fedex.ws.ship.v26.Money total) {
        this.total = total;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "EdtCommodityTax"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "EdtTaxDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Total"));
