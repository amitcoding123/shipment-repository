...
public class ShipmentRating  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.ReturnedRateType actualRateType;

    /* The "list" total net charge minus "actual" total net charge. */
    private com.fedex.ws.ship.v26.Money effectiveNetDiscount;

    /* Each element of this field provides shipment-level rate totals
     * for a specific rate type. */
    private com.fedex.ws.ship.v26.ShipmentRateDetail[] shipmentRateDetails;

    public ShipmentRating() {
    }

    public ShipmentRating(
           com.fedex.ws.ship.v26.ReturnedRateType actualRateType,
           com.fedex.ws.ship.v26.Money effectiveNetDiscount,
           com.fedex.ws.ship.v26.ShipmentRateDetail[] shipmentRateDetails) {
     ...
     * is considered as presenting the "actual" rates for the shipment.
     */
    public com.fedex.ws.ship.v26.ReturnedRateType getActualRateType() {
     ...
     * is considered as presenting the "actual" rates for the shipment.
     */
    public void setActualRateType(com.fedex.ws.ship.v26.ReturnedRateType actualRateType) {
        this.actualRateType = actualRateType;
    }
     ...
     */
    public com.fedex.ws.ship.v26.Money getEffectiveNetDiscount() {
     ...
     */
    public void setEffectiveNetDiscount(com.fedex.ws.ship.v26.Money effectiveNetDiscount) {
        this.effectiveNetDiscount = effectiveNetDiscount;
    }
     ...
     * for a specific rate type.
     */
    public com.fedex.ws.ship.v26.ShipmentRateDetail[] getShipmentRateDetails() {
     ...
     * for a specific rate type.
     */
    public void setShipmentRateDetails(com.fedex.ws.ship.v26.ShipmentRateDetail[] shipmentRateDetails) {
        this.shipmentRateDetails = shipmentRateDetails;
    }

    public com.fedex.ws.ship.v26.ShipmentRateDetail getShipmentRateDetails(int i) {
        return this.shipmentRateDetails[i];
    }

    public void setShipmentRateDetails(int i, com.fedex.ws.ship.v26.ShipmentRateDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShipmentRating"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("actualRateType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ActualRateType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "EffectiveNetDiscount"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShipmentRateDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShipmentRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
