...
public class ShipmentDryIceDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.ShipmentDryIceProcessingOptionType[] processingOptions;
    ...
    public ShipmentDryIceDetail(
           ...
           com.fedex.ws.ship.v26.ShipmentDryIceProcessingOptionType[] processingOptions) {
     ...
     */
    public com.fedex.ws.ship.v26.ShipmentDryIceProcessingOptionType[] getProcessingOptions() {
        return processingOptions;
    }
     ...
     */
    public void setProcessingOptions(com.fedex.ws.ship.v26.ShipmentDryIceProcessingOptionType[] processingOptions) {
        this.processingOptions = processingOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShipmentDryIceDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShipmentDryIceProcessingOptionType"));
