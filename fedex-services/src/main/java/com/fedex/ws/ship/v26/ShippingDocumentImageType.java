...
public class ShippingDocumentImageType implements java.io.Serializable {
    ...
    public static final java.lang.String _DIB = "DIB";
    ...
    public static final ShippingDocumentImageType DIB = new ShippingDocumentImageType(_DIB);
    ...
    public static final ShippingDocumentImageType GIF = new ShippingDocumentImageType(_GIF);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShippingDocumentImageType"));
    }
    /**
