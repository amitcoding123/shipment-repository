...
public class FreightRateDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.FreightRateQuoteType quoteType;

    /* Specifies how total base charge is determined. */
    private com.fedex.ws.ship.v26.FreightBaseChargeCalculationType baseChargeCalculation;

    /* Freight charges which accumulate to the total base charge for
     * the shipment. */
    private com.fedex.ws.ship.v26.FreightBaseCharge[] baseCharges;

    /* Human-readable descriptions of additional information on this
     * shipment rating. */
    private com.fedex.ws.ship.v26.FreightRateNotation[] notations;
    ...
    public FreightRateDetail(
           ...
           com.fedex.ws.ship.v26.FreightRateQuoteType quoteType,
           com.fedex.ws.ship.v26.FreightBaseChargeCalculationType baseChargeCalculation,
           com.fedex.ws.ship.v26.FreightBaseCharge[] baseCharges,
           com.fedex.ws.ship.v26.FreightRateNotation[] notations) {
     ...
     */
    public com.fedex.ws.ship.v26.FreightRateQuoteType getQuoteType() {
        return quoteType;
    }
     ...
     */
    public void setQuoteType(com.fedex.ws.ship.v26.FreightRateQuoteType quoteType) {
        this.quoteType = quoteType;
    }
     ...
     */
    public com.fedex.ws.ship.v26.FreightBaseChargeCalculationType getBaseChargeCalculation() {
     ...
     */
    public void setBaseChargeCalculation(com.fedex.ws.ship.v26.FreightBaseChargeCalculationType baseChargeCalculation) {
        this.baseChargeCalculation = baseChargeCalculation;
    }
     ...
     * the shipment.
     */
    public com.fedex.ws.ship.v26.FreightBaseCharge[] getBaseCharges() {
        return baseCharges;
    }
     ...
     * the shipment.
     */
    public void setBaseCharges(com.fedex.ws.ship.v26.FreightBaseCharge[] baseCharges) {
        this.baseCharges = baseCharges;
    }

    public com.fedex.ws.ship.v26.FreightBaseCharge getBaseCharges(int i) {
        return this.baseCharges[i];
    }

    public void setBaseCharges(int i, com.fedex.ws.ship.v26.FreightBaseCharge _value) {
     ...
     * shipment rating.
     */
    public com.fedex.ws.ship.v26.FreightRateNotation[] getNotations() {
        return notations;
    }
     ...
     * shipment rating.
     */
    public void setNotations(com.fedex.ws.ship.v26.FreightRateNotation[] notations) {
        this.notations = notations;
    }

    public com.fedex.ws.ship.v26.FreightRateNotation getNotations(int i) {
        return this.notations[i];
    }

    public void setNotations(int i, com.fedex.ws.ship.v26.FreightRateNotation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "FreightRateDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("quoteNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "QuoteNumber"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "QuoteType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "FreightRateQuoteType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("baseChargeCalculation");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BaseChargeCalculation"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "FreightBaseChargeCalculationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("baseCharges");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BaseCharges"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "FreightBaseCharge"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Notations"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "FreightRateNotation"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
