...
public class RateRequestType implements java.io.Serializable {
    ...
    public static final java.lang.String _RATED = "RATED";
    public static final RateRequestType CUSTOM = new RateRequestType(_CUSTOM);
    public static final RateRequestType INCENTIVE = new RateRequestType(_INCENTIVE);
    ...
    public static final RateRequestType RATED = new RateRequestType(_RATED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RateRequestType"));
    }
    /**
