...
public class RadionuclideDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.RadionuclideActivity activity;
    ...
    private com.fedex.ws.ship.v26.PhysicalFormType physicalForm;
    ...
    public RadionuclideDetail(
           ...
           com.fedex.ws.ship.v26.RadionuclideActivity activity,
           java.lang.Boolean exceptedPackagingIsReportableQuantity,
           com.fedex.ws.ship.v26.PhysicalFormType physicalForm,
     ...
     * @return activity
     */
    public com.fedex.ws.ship.v26.RadionuclideActivity getActivity() {
        return activity;
    }
     ...
     * @param activity
     */
    public void setActivity(com.fedex.ws.ship.v26.RadionuclideActivity activity) {
        this.activity = activity;
    }
     ...
     * @return physicalForm
     */
    public com.fedex.ws.ship.v26.PhysicalFormType getPhysicalForm() {
        return physicalForm;
    }
     ...
     * @param physicalForm
     */
    public void setPhysicalForm(com.fedex.ws.ship.v26.PhysicalFormType physicalForm) {
        this.physicalForm = physicalForm;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RadionuclideDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("radionuclide");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Radionuclide"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Activity"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "RadionuclideActivity"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("exceptedPackagingIsReportableQuantity");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ExceptedPackagingIsReportableQuantity"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PhysicalForm"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PhysicalFormType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("chemicalForm");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ChemicalForm"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
