...
public class NaftaLowValueStatementDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.CustomsRoleType role;

    public NaftaLowValueStatementDetail() {
    }

    public NaftaLowValueStatementDetail(
           com.fedex.ws.ship.v26.CustomsRoleType role) {
           this.role = role;
    }
     ...
     */
    public com.fedex.ws.ship.v26.CustomsRoleType getRole() {
        return role;
    }
     ...
     */
    public void setRole(com.fedex.ws.ship.v26.CustomsRoleType role) {
        this.role = role;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "NaftaLowValueStatementDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("role");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "Role"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CustomsRoleType"));
