...
public class CreditCardType implements java.io.Serializable {
    ...
    public static final CreditCardType AMEX = new CreditCardType(_AMEX);
    public static final CreditCardType DINERS = new CreditCardType(_DINERS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "CreditCardType"));
    }
    /**
