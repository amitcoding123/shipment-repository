...
public class ShipmentManifestDetail  implements java.io.Serializable {
     ...
     * manifest ID. */
    private com.fedex.ws.ship.v26.CustomerReferenceType manifestReferenceType;

    public ShipmentManifestDetail() {
    }

    public ShipmentManifestDetail(
           com.fedex.ws.ship.v26.CustomerReferenceType manifestReferenceType) {
     ...
     * manifest ID.
     */
    public com.fedex.ws.ship.v26.CustomerReferenceType getManifestReferenceType() {
     ...
     * manifest ID.
     */
    public void setManifestReferenceType(com.fedex.ws.ship.v26.CustomerReferenceType manifestReferenceType) {
        this.manifestReferenceType = manifestReferenceType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ShipmentManifestDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("manifestReferenceType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "ManifestReferenceType"));
