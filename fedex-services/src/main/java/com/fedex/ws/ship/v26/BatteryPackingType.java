...
public class BatteryPackingType implements java.io.Serializable {
    ...
    public static final BatteryPackingType UNKNOWN = new BatteryPackingType(_UNKNOWN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BatteryPackingType"));
    }
    /**
