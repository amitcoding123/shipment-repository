...
public class PackageSpecialServicesRequested  implements java.io.Serializable {
    ...
    private com.fedex.ws.ship.v26.DangerousGoodsDetail dangerousGoodsDetail;

    /* Provides details about the batteries or cells that are contained
     * within this specific package. */
    private com.fedex.ws.ship.v26.BatteryClassificationDetail[] batteryDetails;

    private com.fedex.ws.ship.v26.Weight dryIceWeight;

    private com.fedex.ws.ship.v26.SignatureOptionDetail signatureOptionDetail;

    private org.apache.axis.types.NonNegativeInteger pieceCountVerificationBoxCount;

    private com.fedex.ws.ship.v26.PriorityAlertDetail priorityAlertDetail;

    private com.fedex.ws.ship.v26.AlcoholDetail alcoholDetail;
    ...
    public PackageSpecialServicesRequested(
           ...
           com.fedex.ws.ship.v26.DangerousGoodsDetail dangerousGoodsDetail,
           com.fedex.ws.ship.v26.BatteryClassificationDetail[] batteryDetails,
           com.fedex.ws.ship.v26.Weight dryIceWeight,
           com.fedex.ws.ship.v26.SignatureOptionDetail signatureOptionDetail,
           org.apache.axis.types.NonNegativeInteger pieceCountVerificationBoxCount,
           com.fedex.ws.ship.v26.PriorityAlertDetail priorityAlertDetail,
           com.fedex.ws.ship.v26.AlcoholDetail alcoholDetail) {
     ...
     */
    public com.fedex.ws.ship.v26.DangerousGoodsDetail getDangerousGoodsDetail() {
        return dangerousGoodsDetail;
    }
     ...
     */
    public void setDangerousGoodsDetail(com.fedex.ws.ship.v26.DangerousGoodsDetail dangerousGoodsDetail) {
        this.dangerousGoodsDetail = dangerousGoodsDetail;
    }
     ...
     * within this specific package.
     */
    public com.fedex.ws.ship.v26.BatteryClassificationDetail[] getBatteryDetails() {
     ...
     * within this specific package.
     */
    public void setBatteryDetails(com.fedex.ws.ship.v26.BatteryClassificationDetail[] batteryDetails) {
        this.batteryDetails = batteryDetails;
    }

    public com.fedex.ws.ship.v26.BatteryClassificationDetail getBatteryDetails(int i) {
        return this.batteryDetails[i];
    }

    public void setBatteryDetails(int i, com.fedex.ws.ship.v26.BatteryClassificationDetail _value) {
     ...
     */
    public com.fedex.ws.ship.v26.SignatureOptionDetail getSignatureOptionDetail() {
        return signatureOptionDetail;
    }
     ...
     */
    public void setSignatureOptionDetail(com.fedex.ws.ship.v26.SignatureOptionDetail signatureOptionDetail) {
        this.signatureOptionDetail = signatureOptionDetail;
    }
     ...
     */
    public com.fedex.ws.ship.v26.PriorityAlertDetail getPriorityAlertDetail() {
        return priorityAlertDetail;
    }
     ...
     */
    public void setPriorityAlertDetail(com.fedex.ws.ship.v26.PriorityAlertDetail priorityAlertDetail) {
        this.priorityAlertDetail = priorityAlertDetail;
    }
     ...
     */
    public com.fedex.ws.ship.v26.AlcoholDetail getAlcoholDetail() {
        return alcoholDetail;
    }
     ...
     * @param alcoholDetail
     */
    public void setAlcoholDetail(com.fedex.ws.ship.v26.AlcoholDetail alcoholDetail) {
        this.alcoholDetail = alcoholDetail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PackageSpecialServicesRequested"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "DangerousGoodsDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BatteryDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "BatteryClassificationDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "SignatureOptionDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "SignatureOptionDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("pieceCountVerificationBoxCount");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PieceCountVerificationBoxCount"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PriorityAlertDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "PriorityAlertDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("alcoholDetail");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "AlcoholDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v26", "AlcoholDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
